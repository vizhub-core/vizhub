...
export const args = {
  notificationsResult: {
    ...
    comments: {
      comment1: {
        ...
        author: 'user1',
        markdown:
          'Great visualization! I love the color scheme.',
      },
      comment2: {
        id: 'comment2',
        author: 'user2',
        markdown:
          'Have you considered adding a legend to this chart?',
      },
      comment3: {
        id: 'comment3',
        author: 'user3',
    ...
    commentAuthorImages: {
      ...
      user3:
        'https://avatars.githubusercontent.com/u/7654321?v=4',
    },
    resourceTitles: {
  ...
  onMarkAsReads: new Map([
    ...
    [
      '2',
      async () =>
        console.log('Marked notification 2 as read'),
    ],
    [
      '3',
      async () =>
        console.log('Marked notification 3 as read'),
    ],
  ]),
