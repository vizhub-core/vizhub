...
describe('seoMetaTags', () => {
  it('degenerate case', () => {
    ...
    expect(meta)
      .toEqual(`<link rel="alternate" type="application/json+oembed" href="https://vizhub.com/oembed?url=https://vizhub.com/test-page" title="Test Title"/>
    <meta name="twitter:title" content="Test Title"/>
    <meta property="og:title" content="Test Title"/>
    <meta name="twitter:url" content="https://vizhub.com/test-page"/>
    <meta property="og:url" content="https://vizhub.com/test-page"/>
